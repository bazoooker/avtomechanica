...
?>
			...
			<div class="bx_ordercart_order_pay_center"><a href="javascript:void();" onClick="submitForm('Y'); return false;" class="btn btn-danger rounded-pill"><?=GetMessage("SOA_TEMPL_BUTTON")?></a></div>
