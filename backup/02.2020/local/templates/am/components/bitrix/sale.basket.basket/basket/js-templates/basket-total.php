...
<script id="basket-total-template" type="text/html">
            <div class="checkout-block bg-info">
              	<div class="checkout-block__total">Итого: <span data-entity="basket-total-price" class=rub>{{{PRICE}}}</span></div>


		<a href="/cart/make/" class="btn btn-main btn-hover-white btn-no-icon">
