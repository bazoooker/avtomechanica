;(function() {
	...
	//		if (this.result && this.result.TOTAL_RENDER_DATA && parseFloat(this.result.TOTAL_RENDER_DATA.PRICE) > parseFloat(totalData.PRICE))
			if (this.result && this.result.TOTAL_RENDER_DATA)
			{
...
//			totalData.PRICE=number_format(totalData.PRICE, 0, '', ' ');
...
//EEEEE
		...
		//alert(itemData.SUM_PRICE);
//			itemData.PRICE=number_format(itemData.PRICE, 0, '', ' ');
//			itemData.PRICE_FORMATED=number_format(itemData.PRICE_FORMATED, 0, '', ' ');

//			itemData.SUM_PRICE=number_format(itemData.SUM_PRICE, 0, '', ' ');
			return itemData;
		},
		...
		createBasketItem: function(itemId)
		{
			...
			{
//				console.log(this.items[itemId].PRICE);
//				this.items[itemId].PRICE_FORMATED=number_format(this.items[itemId].PRICE, 0, '', ' ');
		...
		{
			// pugach
//			number_format($('#item-price-total')
//			return number_format(price, 0, '', ' ');
		return price; //BX.Currency.currencyFormat(price, currency, true);
		},
...
//							$('#item-price-total').text(number_format($('#item-price-total').text(), 0, '', ' '));
