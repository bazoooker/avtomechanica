...
<div class="search">
	...
	<div class="search-form">
		...
		<?else:?>
			<input id=search_field type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
		<?endif;?>

			<input  id=search_button type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
...
<p>Вот что мы нашли по запросу "<?=$arResult["REQUEST"]["QUERY"]?>"</p>
