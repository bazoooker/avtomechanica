...
foreach ($arResult['ITEMS'] as $key => $arItem){
			$file=CFile::ResizeImageGet($arItem['PREVIEW_PICTURE'], array('width'=>350, 'height'=>350), BX_RESIZE_IMAGE_PROPORTIONAL_ALT , true); 
...
?>
                                    ...
                                    <div class="col-12 col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                        <div class="product border-radius">
                                             <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="product-img" style="background-image: url(<?=$file['src']?>);"></a>
